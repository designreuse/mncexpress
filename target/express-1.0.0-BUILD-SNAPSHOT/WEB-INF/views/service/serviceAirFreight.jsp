				...
				<div class="divide">
					...
					<div class="right_cont">
						...
						<div class="section"  id="airfreight">
							<h2><spring:message code="service.air0"/></h2>
							<div class="image_text">
								<div class="img_area">
									<img src="<c:url value='/resources/images/service/air.jpg/'/>" >
								</div>
								<p>
									<spring:message code="service.air1"/> 
								</p>								
							</div>
							<div class="detail_text">
								<ul>
									<spring:message code="service.air2"/> 										
								</ul>
							</div>
						</div>
						<!--//section1-->
